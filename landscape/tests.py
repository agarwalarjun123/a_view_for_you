...
def add_review_to_landscape(landscape):
    ...
    Review.objects.get_or_create(title=review["title"], description=review["description"],
                                 rating=float(review["rating"]), visit_date=review["visit_date"],
...
def add_landscape():
    ...
    Landscape.objects.get_or_create(name=landscape["name"], description=landscape["description"],
                                    address=landscape["address"], latitude=landscape["latitude"],
    ...
    landscapes = [
        {
            ...
            "images": [
                "https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/BenNevis2005.jpg/1920px-BenNevis2005.jpg"],
            "accessibilities": [],
        ...
        },
        {
            ...
            "images": [
                "https://thumbs.dreamstime.com/b/remote-mountain-cottage-glencoe-picture-postcard-scottish-highlands-79753771.jpg"],
            "activities": ["boating"],
            "accessibilities": [
                "wheelchair"
            ],
            ...
            "reviews": [{
                ...
                "user_id": User.objects.first,
                "images": [
                    "https://thumbs.dreamstime.com/b/river-coe-glencoe-scotland-rising-sun-lighting-mountain-peaks-highlands-79756495.jpg"]
            },
                {
                    ...
                    "images": [
                        "https://thumbs.dreamstime.com/b/moody-panoramic-three-sisters-mountains-glencoe-covered-rusty-moorlands-scotland-150292777.jpg",
        ...
        },
        {
            ...
            "images": [
                "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/80/1e/29/loch-katrine.jpg?w=2000&h=-1&s=1"],
            "activities": [
                "boating",
                "hiking",
                "fishing", "swimming"
        ...
        },
        {
            ...
            "images": [
                "https://upload.wikimedia.org/wikipedia/commons/a/a7/South_over_the_Quiraing%2C_Isle_of_Skye.jpg"],
            "activities": ["hiking"],
        ...
        },
        {
            ...
            "images": [
                "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/14/2b/f3/60/img-20180816-131447-largejpg.jpg?w=1000&h=-1&s=1"],
            "activities": [""],
            "accessibilities": ["parking"],
        ...
        },
        {
            ...
            "images": ["https://www.visitinvernesslochness.com/sites/default/files/2021-09/DJI_0271__1920.jpg",
                       "https://cdn.britannica.com/77/2977-050-6CEA9F21/Loch-Ness-Highlands-of-Scotland-head-monastery.jpg",
                       "https://ichef.bbci.co.uk/news/976/cpsprodpb/E751/production/_107971295_lochnessone.jpg",
                       "https://ichef.bbci.co.uk/news/976/cpsprodpb/E751/production/_107971295_lochnessone.jpg",
                       "https://ichef.bbci.co.uk/news/976/cpsprodpb/E751/production/_107971295_lochnessone.jpg"],
            "activities": ["swimming"],
